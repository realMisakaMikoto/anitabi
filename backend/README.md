...
- `POST /v1/navigation/reserve`: reserves 1-25 Navigation SDK destinations before the Android SDK is called. Its deprecated `remainingToday` response field remains present with the unbounded compatibility value `2147483647` for existing v0.2.3 clients.
